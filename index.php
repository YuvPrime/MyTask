   ...
   <div class="table">
    ...
    <div class="table-row header">
      ...
      <div class="cell">Total</div>
                ...
                b ON a.tweet_id = b.tweet_id WHERE b.is_rt = 0 AND a.`tag` = '$tag_name_one'  GROUP BY b.screen_name
    ...
    <div class="table-row header blue">
      ...
      <div class="cell">Total</div>
               ...
               $query_c = "SELECT DISTINCT b.screen_name as name, b.profile_image_url as profile_image, 
                b.created_at as created, a.tag as tag, COUNT(a.tag) as count FROM `tweet_tags` a JOIN tweets 
                b ON a.tweet_id = b.tweet_id WHERE b.is_rt = 0 AND a.`tag` = '$tag_name_two'  GROUP BY b.screen_name
                 ORDER BY count DESC LIMIT 0, 10";
...
setInterval(function() 
   ...
   success: function(data) {
    ...
    //console.log(json.total.total_tweets);
    //console.log(json.first.first);
    //console.log(json.second.second);
